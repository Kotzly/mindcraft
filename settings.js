const settings = {
    ...
    "load_memory": true, // load memory (conversation history, todo list, command history) from previous session on restart
    ...
    "summary_chunk_size": 5, // number of messages to summarize into memory when hitting max_messages
